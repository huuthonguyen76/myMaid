  ...
  angular.
    ...
    .config(function($stateProvider, $urlRouterProvider) {
      ...
      $stateProvider
        .state('admin', {
          url           : '/admin',
          templateUrl   : 'public/app/modules/admin/views/admin.html',
          controller    : 'adminCtrl'
        })
        .state('admin.dashboard', {
          url           : '/dashboard',
          templateUrl   : 'public/app/modules/admin/views/dashboard.html',
          controller    : 'adminDashboardCtrl'
        })
        .state('admin.addPost', {
          url           : '/addPost',
          templateUrl   : 'public/app/modules/admin/views/addPost.html',
          controller    : 'adminAddPostCtrl'
        })
        .state('admin.categoryManagement', {
          url           : '/categoryManagement',
          templateUrl   : 'public/app/modules/admin/views/categoryManagement.html',
          controller    : 'adminCategoryManagementCtrl'
        })
        .state('general', {
          url           : '/general',
          templateUrl   : 'public/app/modules/general/views/general.html',
          controller    : 'generalCtrl'
        })
        .state('general.home', {
          url           : '/home',
          templateUrl   : 'public/app/modules/general/views/home.html',
          controller    : 'generalHomeCtrl'
        })
        .state('general.detail', {
          url           : '/detail/:postId',
          templateUrl   : 'pubic/app/modules/general/views/detail.html',
          controller    : 'generalDetailCtrl'
        })
        .state('general.contact', {
          url           : '/contact',
          templateUrl   : 'pubic/app/modules/general/views/contact.html',
